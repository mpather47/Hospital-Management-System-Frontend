...
export function Employee() {
    ...
    var columns = [
        {title: "Employee ID", field: "visitId"},
        {title: "Employee name", field: "patientId"},
        {title: "Position", field: "doctorId"},
        {title: "Certification", field: "prescriptionId"},
        {title: "Birth Date", field: "visitDate", type: 'date'}
    ...
    const handleRowUpdate = (newData, oldData, resolve) => {
        ...
        if(newData.doctorId === "") {
            errorList.push("Please enter valid position.")
        }
        if(newData.prescriptionId === "") {
            errorList.push("Please enter an education.")
        }
        if(newData.visitDate === "") {
            errorList.push("Please enter a birth date.")
        }
    ...
    const handleRowAdd = (newData, resolve) => {
        ...
        if(newData.doctorId === undefined) {
            errorList.push("Please enter a position.")
        }
        if(newData.prescriptionId === undefined) {
            errorList.push("Please enter a certification.")
        }
